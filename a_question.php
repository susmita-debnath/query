...
<body>
  ...
  <div class="q_full">
    <div class="q_left">
      <b>Question</b>
      <form method="post">
        <textarea name="question" rows="10" cols="95" placeholder="Start your question with 'What', 'How', 'Why', etc"></textarea><br>
        <div id="add_btn">
      ...
      <?php 
        if ( isset($_POST['add']) ) {
          $query = "INSERT INTO answers (`c_id`, `student_id`, `ques`) VALUES ('$key', '$student_id', '$ques')";
    ...
    <div id="q_right">
      <ul>
        <li><b>Make sure your question has not been asked already</b></li>
        <li><b>Keep your question short and to the point</b></li>
