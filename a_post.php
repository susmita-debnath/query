...
ob_start();
	...
	$query7 = "SELECT s_img, name FROM student WHERE id = '$id'";
	...
	if ( isset($_POST['post_button']) ) {
		...
		$q = "INSERT INTO posts (`c_id`, `student_id`, `dedicated_to`, `post_text`, `post_time`) VALUES ('$key', '$id', '$section', '$post_text', '$date')";
		$i = mysqli_query($con, $q);
		header("Location:posts.php?key=". $key );
	}
?>
  ...
  <div class="box">
    ...
    <div class="box2">
      ...
      <div id="post_box">     	
      	...
      	?>
      	<div class="avatar"><img src="uploads/<?php echo $rows['s_img']?>" width="50" alt="Circle Image" class="img-raised rounded-circle img-fluid"> <b><?php echo $rows['name'] ?></b><br><br>
      	<?php } ?>
      	<?php echo "&nbsp;" . $batch[0] . $batch[1]. $batch[2] . " batch"; ?>
      	<div id="post_box_box">
      		<hr>
      		<form method="post">
      			<textarea name="post" rows="10" cols="88" placeholder="write here about your THOUGHTS..."></textarea>
      			<div id="img">
      				
      			</div>
      			<div id="dedicated">
      				Dedicated to:
      				<input type="radio" name="section" value="Your section">Your section<br>
      				<input type="radio" name="section" value="All section">All section		
      			</div>
      			<div id="post_btn">
