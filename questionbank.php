<?php
  ...
  $query5 = "SELECT distinct year FROM question_bank WHERE c_id = '$key' ORDER BY year DESC";
 ...
 -->
  ...
  <div class="box">
    <div class="box1">
      ...
      <a href="books.php?key=<?php echo $key;?>" class="books">Books</a>
      ...
      <!-- <div class="sorted">
        <div class="second">
          <button>
			...
			<div class="qq">
        <table>
          <?php foreach ($questions as $year => $yearCount) {
          ?>
            ...
            <tr>
              <td>
								<hr>
                <div class="question">
                  <a href="ques_b_list.php?key=<?php echo $key; ?>&year=<?php echo $year; ?>"><center><?php echo $key; ?> &nbsp;&nbsp; <b><?php echo $yearCount['year']; ?> </b></center></a>
                </div>
							</hr>
              </td>
            </tr>
