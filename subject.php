<?php
  ...
  $query = "SELECT c.c_id AS c_id ,c.c_name AS c_name FROM my_courses AS m JOIN course AS c ON(m.c_id = c.c_id) WHERE student_id = '$id' AND  c.c_id != '$key'ORDER BY c_id";
  //$query = "SELECT c.c_id,c.c_name FROM my_courses AS m JOIN course AS c ON(m.c_id = c.c_id) WHERE student_id = '$id'  AND c_id != '$key' ORDER BY c_id";
  ...
  while($row = mysqli_fetch_assoc($b)) {
    $questions[$row['q_no']] = array( 'ques' => $row['ques'], 'view' => $row['view'] );
      ...
      <div class="collapse navbar-collapse">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="button-container nav-item iframe-extern">
            <a href="a_question.php?key=<?php echo $key; ?>" target="_blank" class="btn  btn-rose   btn-round btn-block">
             Add Question
            </a>
          </li>
        </ul>
 ...
 -->
  ...
  <div class="box">
    <div class="box1">
      ...
      <a href="questionbank.php" class="questions">Question Bank</a>
          ...
          ?>
            ...
            <tr>
              <td>
                ...
                <hr>
                <div class="question">
                  <a href="answers_list.php?key=<?php echo $key; ?>&q_no=<?php echo $q_no; ?>"><?php echo isset( $question['ques'] ) ? $question['ques'] : NULL; ?></a>
                </div>
                <div class="q_info">
                  <div id="v">
                    <div class="writing">
                      <?php echo isset( $question['view'] ) && $question['view'] != NULL ? $question['view'] : 0; ?><br>
                    </div>
                    <a href="#">views</a>
                  </div>
                  <div id="a">
                    <div class="writing">
                      <?php echo isset( $answers[$q_no] ) ? $answers[$q_no] : 0; ?><br>
                    </div>
                    <a href="#">answers</a>
                  </div>
                  <div id="f">
                    <div class="writing">
                      <?php echo isset( $follows[$q_no] ) ? $follows[$q_no] : 0; ?><br>
                    </div>
                    <a href="#">follows</a>
                  </div>               
                </div>
