<?php
  ...
  $query2 = "SELECT * FROM notice ORDER BY notice_no DESC";
  ...
  while($row = mysqli_fetch_assoc($b)) {
    $notices[$row['notice_no']] = array( 'header' => $row['header'],'schedule' => $row['schedule']) ;
 ...
 -->
  ...
  <div class="box">
    ...
    <div class="box2">
      ...
      <div class="qq">
        <table>
          <?php foreach ($notices as $notice_no => $notices) {
          ?>
            ...
            <tr>
              <td>
                ...
                <hr>
                <div class="notice">
                  <a href="notices.php?key=<?php echo $key; ?>&notice_no=<?php echo $notice_no; ?>"><?php echo $notices['schedule'];echo ":"; ?>&nbsp;&nbsp;&nbsp;&nbsp; <b><?php echo $notices['header']; ?></b></a>
                </div>
                <!-- <div class="q_info">
                  <div id="v">
                    <div class="writing">
